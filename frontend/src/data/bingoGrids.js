 ...
 * Win Rule: Even if ANY ONE line (horizontal row, vertical column, or diagonal) is completed (5/5), the team WINS!
 */
export function evaluateBingoCard(setNumber = 1, numbersCollected = []) {
  ...
  return {
    isWinner,
    completedLinesCount,
    requiredNumbers: Array.from(requiredNumbersSet).sort((a, b) => a - b)
  };
}
